  ...
  return `
    ...
    ">
      <div style="text-align: center; margin-bottom: 20px;">
        <h2 style="color: #4A3AFF; margin: 0;">Evently</h2>
      </div>

      <p style="font-size: 16px; color: #333;">
        Hi <strong>${firstName} from Drishti who has successfully implemented email delivery with kafka</strong>
      </p>

      <p style="font-size: 16px; color: #333;">
        Welcome to <strong>Evently</strong> 👋  
